...
<template>
  <div class="min-w-[1200px] relative">
    ...
    currentSlideObject(slide, index)
        ...
        >
          <img alt="" style="user-select: none; min-height: 500px !important;" class=" object-cover pointer-events-none h-[100%] z-[-1]" :src="'/netflix-clone/images/'+slide.name.replace(/ /g, '-')+'.png'">
        </div>
      </Slide>
    </Carousel>
    ...
    currentSlideObject(slide, index)
        ...
        >
          <img alt="" style="user-select: none" class=" object-cover pointer-events-none h-[100%] z-[-1]" :src="'/netflix-clone/images/'+slide.name.replace(/ /g, '-')+'.png'">
        </div>
      </Slide>
